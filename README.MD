...
## O Busca CEP é uma aplicação responsiva javascript,usando fetch API para localizar endereços através do CEP ou o CEP através da rua(logradouro);
...
## Tela de resultado da busca do CEP ##
...
* Link do site da API Via Cep : https://viacep.com.br/
